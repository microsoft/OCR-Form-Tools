...
export interface IProjectService {
    ...
    save(project: IProject, saveTags: boolean, securityToken: ISecurityToken): Promise<IProject>;
...
export default class ProjectService implements IProjectService {
     ...
     */
    public async save(project: IProject, saveTags: boolean, securityToken: ISecurityToken): Promise<IProject> {
        Guard.null(project);
