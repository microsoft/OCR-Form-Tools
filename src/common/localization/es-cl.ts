...
export const spanish: IAppStrings = {
    ...
    tags: {
        ...
        warnings: {
            ...
            checkboxPerTagLimit: "No se puede asignar más de una casilla de verificación por etiqueta",           notCompatibleWithDrawnRegionTag: "Los valores de drawnRegion y $ {otherCatagory} no pueden asignarse a la misma etiqueta del documento",
