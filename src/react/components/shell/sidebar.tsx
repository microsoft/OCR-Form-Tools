               ...
               <li>
                ...
                <li>
                    <ConditionalNavLink disabled={!projectId}
                        ...
                        <i className="ms-Icon ms-Icon--Insights"></i>
                    </ConditionalNavLink>
                </li>
                <li>
                    <ConditionalNavLink disabled={!projectId}
                        ...
                        <i className="ms-Icon ms-Icon--DocumentManagement"></i>
                    </ConditionalNavLink>
                </li>
                <li>
                    <NavLink title={strings.connections.title}
                        to={`/connections`}><i className="ms-Icon ms-Icon--Plug" aria-hidden="true"></i></NavLink>
                </li>
            </ul>
            <div className="app-sidebar-fill"></div>
            <ul>
                <li><NavLink title={strings.appSettings.title}
                    to={`/settings`}><i className="ms-Icon ms-Icon--Settings"></i></NavLink></li>
            </ul>
        </div>
    );
}
